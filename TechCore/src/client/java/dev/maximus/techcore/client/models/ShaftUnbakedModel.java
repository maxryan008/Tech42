...
public class ShaftUnbakedModel implements UnbakedModel {
    private final ResourceLocation id;

    public ShaftUnbakedModel(ResourceLocation id) {
        this.id = id;
    }
    ...
    public @Nullable BakedModel bake(ModelBaker modelBaker, Function<Material, TextureAtlasSprite> function, ModelState modelState) {
        ...
        return new ShaftBakedModel(function.apply(new Material(TextureAtlas.LOCATION_BLOCKS, def.textureLocation())), modelState);
    }
}
